import { processTheme } from './themeProcessor';

// Theme
const rawDark = {
    backgroundDark: 'oklch(15% 0 0)',
    background: 'oklch(20% 0 0)',
    backgroundLight: 'oklch(25% 0 0)',
    text: 'oklch(90% 0 0)',
    textMuted: 'oklch(70% 0 0)',
    border: 'oklch(30% 0 0)',
    borderMuted: 'oklch(22% 0 0)',
...
// Alerts
const rawDanger = 'oklch(65% 0.18 25)';
const rawWarning = 'oklch(75% 0.15 70)';
const rawSuccess = 'oklch(65% 0.15 150)';
const rawInfo = 'oklch(65% 0.15 240)';

export const baseThemes = {
    dark: processTheme(rawDark),
    light: processTheme(rawlight),
};

export const accents = {
    red: processTheme(rawRed),
    orange: processTheme(rawOrange),
    yellow: processTheme(rawYellow),
    green: processTheme(rawGreen),
    blue: processTheme(rawBlue),
    purple: processTheme(rawPurple),
    pink: processTheme(rawpink),
};

export const alerts = {
    danger: processTheme(rawDanger),
    warning: processTheme(rawWarning),
    success: processTheme(rawSuccess),
    info: processTheme(rawInfo),
};